<?php namespace App\Http\Controllers;
	...
	class AdminBrandsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Overview","name"=>"overview"];
			$this->col[] = ["label"=>"Origin","name"=>"origin"];
			$this->col[] = ["label"=>"CEO","name"=>"ceo"];
			$this->col[] = ["label"=>"Headquarters","name"=>"headquarters"];
			$this->col[] = ["label"=>"Est","name"=>"est"];
			...
			$this->form[] = ['label'=>'Headquarters','name'=>'headquarters','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Est','name'=>'est','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Headquarters","name"=>"headquarters","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Est","name"=>"est","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM

            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group">
                        <label>Title</label>
                        <input type="text" class="form-control" value="{{$category->title}}" id="inp_title" placeholder="title">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="input-group">
                        <label>Slug</label>
                        <input type="text" class="form-control" value="{{$category->slug}}" id="inp_slug" placeholder="slug">
                    </div>
                </div>
            </div>
            {{-- <div class="row">
...
<script>
    var data = `{!!$category->specification_attributes!!}`;
    var cover_1 = `{!!$category->cover_specification_attributes_1!!}`;
    var cover_2 = `{!!$category->cover_specification_attributes_2!!}`;
    var review_header_json= `{!!$category->review_headers!!}`;

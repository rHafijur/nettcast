...
<div class="content-panel content-with-sidebar lets-grid-wrap">
    ...
    <div class="ot-grid-column ot-col-3of4">
        ...
        <div class="ot-main-article-list">
         @foreach ($articalesList as $articales)
            <div class="item">
                <div class="item-header item-image">
                    <a href="post.html" class="ot-image-hover"><img src="{{asset($articales->thumbnail)}}" alt="" /></a>
                </div>
                <div class="item-content">
                    <a href="post.html#comments" class="item-image-c">56</a>
                    <div class="item-categies">
                        <a href="category.html" data-ot-css="background-color: #28c357;">{{$articales->title}}</a>
                       <!-- <a href="category.html" data-ot-css="background-color: #298ccb;">Electronics</a> -->
                    </div>
                    <p>{{$description($articales->meta_description)}}</p>
                    <span class="item-meta">
                        <span class="item-meta-i">by <a href="blog.html">{{$articales->author->name}}</a></span>
                        <a href="blog.html" class="item-meta-i">{{$timeDiff($articales->created_at)}}</a>
                    </span>
